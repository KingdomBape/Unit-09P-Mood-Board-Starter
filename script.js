...
function happyMood(){
   ...
   happyImages.forEach(function(x){
       $("body").append("<img src=" + x + ">");
});
}
function sadMood(){
     $("body").css("background-color","blue");
     sadImages.forEach(function(y){
       $("body").append("<img src=" + y + ">");
});
}
function tiredMood(){
  $("body").css("background-color","brown");
  tiredImages.forEach(function(p){
       $("body").append("<img src=" + p + ">");
});
}
function hungryMood(){
     $("body").css("background-color","yellow");
     hungryImages.forEach(function(o){
       $("body").append("<img src=" + o + ">");
});
}
